...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{1\textwidth}
        \centering
        \subcaptionbox{\label{fig:deltaVelocidadCrudo}}{\includegraphics[width=\textwidth]{Figuras/resultados/calibracion/HD51_3/Velocidad de Viento sn 20017378 pat 22106.pdf}}
    \end{minipage}  
    \hspace{2em} % Espacio vertical entre las filas
    \begin{minipage}[b]{1\textwidth}
        \centering
        \subcaptionbox{\label{fig:deltaDireccionCrudo}}{\includegraphics[width=\textwidth]{Figuras/resultados/calibracion/HD51_3/Dirección de Viento sn 20017378 pat 22106.pdf}}
    \end{minipage}  
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{1\textwidth}
        \centering
        \subcaptionbox{\label{fig:deltaGraficoHister}}{\includegraphics[width=\textwidth]{Figuras/resultados/calibracion/HD51_3/Curva de histéresis sn 20017378 pat 22106.pdf}}
    \end{minipage}  
    \hspace{1em} % Espacio vertical entre las filas
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{1\textwidth}
        \centering
        \subcaptionbox{\label{fig:deltaGraficoCalibAsc}}{\includegraphics[width=\textwidth]{Figuras/resultados/calibracion/HD51_3/Curva de calibración Asc sn 20017378 pat 22106.pdf}}
    \end{minipage}  
    \hspace{1em} % Espacio vertical entre las filas
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{1\textwidth}
        \centering
        \subcaptionbox{\label{fig:deltaGraficoCalibDes}}{\includegraphics[width=\textwidth]{Figuras/resultados/calibracion/HD51_3/CurvaCalibraciónDesSn20017378Pat22106.pdf}}
    \end{minipage}  
    \hspace{2em} % Espacio vertical entre las filas
    \begin{minipage}[b]{0.7\textwidth}
        \centering
