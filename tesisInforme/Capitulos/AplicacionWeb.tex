...
\begin{itemize}
    ...
    \item Generar un perfil de referencias de velocidad de viento, que se van a transmitir al datalogger para controlar el motor del túnel.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{Figuras/AplicacionWeb/backend/trayectoriaGenerada.jpg}
...
El algoritmo calcula la incertidumbre con los puntos parceados en la seccion anterior, el En la tabla \ref{} se muestran las incertidumbres consiredaras, el algoritmo realiza para cada punto de viento configurador por software, la siguiente cuenta 
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{Figuras/AplicacionWeb/backend/DiagramaFlujoCalculoIncertidumbre.png}
    \caption{Diagrama de flujo del calculo de incertidumbre.}
