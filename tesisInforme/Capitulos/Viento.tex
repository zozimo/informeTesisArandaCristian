...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{En (a) se muestra la vista lateral izquierda de la zona de medición, en (b) se muestran los álabes instalados en la parte derecha de la zona de medición, en (c) una vista frontal de la zona de medición.}
